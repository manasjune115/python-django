...
Comment=old.Comment);
				...
				return render(request,'home1.html',{'content_title':'Edit Employee','form1':form,'action_url':'edit/%s'%(ssn), 'enctype':"multipart/form-data",'emp':True})
			...
			if request.method=='POST': # If the form has been submitted...
				...
				if form.is_valid(): # All validation rules pass
					...
					obj.save();	
			 	       	...
			 	       	return render(request,'home1.html',{'content_title':"Invalid or Insufficient data Try again",'form1':form,'action_url':'/addproject/','enctype':"multipart/form-data"} );
			
			else:
					
		 	       	return render(request,'home1.html',{'content_title': 'Enter the Project Detail','form1':form,'action_url':'/addproject/','enctype':"multipart/form-data"} );
		else:
			return HttpResponseRedirect('/accounts/login/');
...
Tender_Submitted=old.Tender_Submitted,Contract=old.Contract,Third_Party=no1,Modified_By=user,Modified_On="");
				...
				return render(request,'home1.html',{'content_title':'Edit Project','form1':form,'action_url':'edit_project/%s'%(ssn),'enctype':"multipart/form-data"})
		...
		form=None;
			...
			if request.method=='POST': # If the form has been submitted...
				...
				if form.is_valid(): # All validation rules pass
					...
					obj.save();	
		            		return render(request,'home1.html',{'content_title':"Appointment Record Added Successfully"} );
				else:
					
		 	       		return render(request,'home1.html',{'content_title':"Invalid or Insufficient data Try again",'form1':form,'action_url':'/addapp/','enctype':"multipart/form-data"} );

			else:
					
		 	       	return render(request,'home1.html',{'content_title':"Enter Data",'form1':form,'action_url':'/addapp/','enctype':"multipart/form-data"} );
		else:
			return HttpResponseRedirect('/accounts/login/');
...
def edit_app(request, ssn):
			 form=None;
				...
				return render(request,'home1.html',{'content_title':'Edit Appointment','form1':form,'action_url':'editapp/%s'%(ssn),'enctype':"multipart/form-data"})
		...
		form=None;
			...
			if request.method=='POST': # If the form has been submitted...
				...
				if form.is_valid(): # All validation rules pass
					...
					obj.save();	
		            		return render(request,'home1.html',{'content_title':"Duration Record Added Successfully"} );
				else:
					
		 	       		return render(request,'home1.html',{'content_title':"Invalid or Insufficient data Try again",'form1':form,'action_url':'/adddur/','enctype':"multipart/form-data"} );

			else:
					
		 	       	return render(request,'home1.html',{'content_title':"Enter Data",'form1':form,'action_url':'/adddur/','enctype':"multipart/form-data"} );
		else:
			return HttpResponseRedirect('/accounts/login/');
...
def edit_dur(request, ssn):
			 form=None;
				...
				return render(request,'home1.html',{'content_title':'Edit Duration','form1':form,'action_url':'editdur/%s'%(ssn),'enctype':"multipart/form-data"})
		...
		form=None;
			...
			if request.method=='POST': # If the form has been submitted...
				...
				if form.is_valid(): # All validation rules pass
					...
					obj.save();	
		            		return render(request,'home1.html',{'content_title':"Powers Record Added Successfully"} );
				else:
					
		 	       		return render(request,'home1.html',{'content_title':"Invalid or Insufficient data Try again",'form1':form,'action_url':'/addpad/','enctype':"multipart/form-data"} );

			else:
					
		 	       	return render(request,'home1.html',{'content_title':"Enter Data",'form1':form,'action_url':'/addpad/','enctype':"multipart/form-data"} );
		else:
			return HttpResponseRedirect('/accounts/login/');
...
def edit_pad(request, ssn):
			 form=None;
				...
				return render(request,'home1.html',{'content_title':'Edit Powers and duties ','form1':form,'action_url':'editpad/%s'%(ssn),'enctype':"multipart/form-data"})
		...
		form=None;
			...
			if request.method=='POST': # If the form has been submitted...
				...
				if form.is_valid(): # All validation rules pass
					...
					obj.save();	
		            		return render(request,'home1.html',{'content_title':"Removal Record Added Successfully"} );
				else:
					
		 	       		return render(request,'home1.html',{'content_title':"Invalid or Insufficient data Try again",'form1':form,'action_url':'/addrem/','enctype':"multipart/form-data"} );

			else:
					
		 	       	return render(request,'home1.html',{'content_title':"Enter Data",'form1':form,'action_url':'/addrem/','enctype':"multipart/form-data"} );
		else:
			return HttpResponseRedirect('/accounts/login/');
...
def edit_rem(request, ssn):
			 form=None;
				...
				return render(request,'home1.html',{'content_title':'Edit Removal ','form1':form,'action_url':'editrem/%s'%(ssn),'enctype':"multipart/form-data"})
		...
		form=None;
			...
			if request.method=='POST': # If the form has been submitted...
				...
				if form.is_valid(): # All validation rules pass
					...
					obj.save();	
		            		return render(request,'home1.html',{'content_title':"Designation Added Successfully"} );
				else:
					
		 	       		return render(request,'home1.html',{'content_title':"Invalid or Insufficient data Try again",'form1':form,'action_url':'/add_desig/','enctype':"multipart/form-data"} );

			else:
					
		 	       	return render(request,'home1.html',{'content_title':"Enter Data",'form1':form,'action_url':'/add_desig/','enctype':"multipart/form-data"} );
		else:
			return HttpResponseRedirect('/accounts/login/');
...
def edit_desig(request, ssn):
			 form=None;
				...
				return render(request,'home1.html',{'content_title':'Edit Designation ','form1':form,'action_url':'editdesig/%s'%(ssn),'enctype':"multipart/form-data"})
		...
		form=None;
			...
			if request.method=='POST': # If the form has been submitted...
				...
				if form.is_valid(): # All validation rules pass
					...
					obj.save();	
		            		return render(request,'home1.html',{'content_title':" Third Party Added Successfully"} );
				else:
					
		 	       		return render(request,'home1.html',{'content_title':"Invalid or Insufficient data Try again",'form':form,'action_url':'/addthirdparty/'} );

			else:
					
		 	       	return render(request,'home1.html',{'content_title':"Enter ThirdParty's Data",'form':form,'action_url':'/addthirdparty/'} );
		else:
			return HttpResponseRedirect('/accounts/login/');
...
def edit_party(request, ssn):
			 form=None;
				...
				return render(request,'home1.html',{'content_title':'Edit Third Party','form':form,'action_url':'editparty/%s'%(ssn)})
						...
						if n.lower()=="project":
							for n in name:						
								if n.isdigit() and len(n)==4:
									...
									filter|=Q()		
							for n in name:
								q3 |= Q(Project_Name__iexact=n) |Q(Amt_Proposed__iexact=n)| Q(filter);
